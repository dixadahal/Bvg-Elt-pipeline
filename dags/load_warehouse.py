...
INSERT INTO warehouse.station_dim (station_id, stop_name, stop_lat, stop_lon)
...
INSERT INTO warehouse.route_dim (route_id, route_short_name, route_long_name, route_type)
...
INSERT INTO warehouse.date_dim (date_id, year, month, day, day_of_week)
...
CREATE TABLE IF NOT EXISTS warehouse.ridership_fact (
    ...
    station_id TEXT REFERENCES warehouse.station_dim(station_id),
    route_id TEXT REFERENCES warehouse.route_dim(route_id),
    trip_id TEXT,
    passenger_count INT
);

INSERT INTO warehouse.ridership_fact (date_id, station_id, route_id, trip_id, passenger_count)
SELECT
